from base.error import InitializeError, IncompatibleDimensionError
from numpy import identity, ndarray, subtract
...
class GenericCircuit:
    ...
    def __init__(self, dim: int, matrix: [[complex]]):
        ...
        # 各要素の絶対値を求めてから丸める
        expected_zero = np.round(np.abs(hermite - identity(int(dim), complex)), approx_digit)
